...
@pytest.mark.parametrize('df_in_1, corr_matrix',
                            [
                                (pd.DataFrame(np.array([[1,2,3],[1,2,3],[1,2,3]]), columns=['col1', 'col2', 'col3']), 
                                pd.DataFrame(np.array([[1,1,1],[1,1,1],[1,1,1]]), columns=['col1','col2','col3'],index=['col1','col2','col3'])),
                                (pd.DataFrame(np.array([[1,2,3],[234,123,252],[2131,2521,5232]]), columns=['col1','col2','col3']),
                                pd.DataFrame(np.array([[1,0,0],[0,1,0],[0,0,1]]), columns=['col1','col2','col3'],index=['col1','col2','col3']))
                            ])
...
@pytest.mark.parametrize('corr_in, corr_out',
                            [
                                (pd.DataFrame(np.array([[1,1,1],[1,1,1],[1,1,1]]), columns=['col1','col2','col3'],index=['col1','col2','col3']),
                                pd.DataFrame(np.array([[0,1,1],[0,0,1],[0,0,0]]), columns=['col1','col2','col3'],index=['col1','col2','col3'])),
                                (pd.DataFrame(np.array([[1,2],[3,4]])), pd.DataFrame(np.array([[0,2],[0,0]])))
                            ])
...
@pytest.mark.parametrize('corr_in_ , exclude, value', 
                            [
                                (pd.DataFrame(np.array([[0,1,1],[0,0,1],[0,0,0]]), columns=['col1','col2','col3'],index=['col1','col2','col3']),
                                False,
                                np.array([['col1','col2', 1], ['col1', 'col3', 1], ['col2','col3',1]])),
                                (pd.DataFrame(np.array([[0,1,1],[0,0,1],[0,0,0]]), columns=['col1','col2','col3'],index=['col1','col2','col3']),
                                'col2',
