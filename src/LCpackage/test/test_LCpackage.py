...
@pytest.mark.parametrize('df_in, thresh, df_out',
                         [
                             ...
                             (pd.DataFrame(data={'col1': [1, 2, 10, 100],
                              'col2': [1, 2, 3, 4]}),
...
@pytest.mark.parametrize('array_in, sorted',
                         [
                             (np.array([['a', 'b', 1], ['a', 'c', -100],
                                        ['a', 'd', -20]]),
                              np.array([['a', 'b', 1], ['a', 'd', -20],
                                        ['a', 'c', -100]])),
                             (np.array([[1, 3, 45], [1, 5, 32], [12, 43, 2],
                                        [1, 2, -90]]),
                              np.array([[12, 43, 2], [1, 5, 32], [1, 3, 45],
                                        [1, 2, -90]]))
                         ])
